...
async def test_hybrid_search_scoring():
    ...
    assert len(results) == 2 # chunk_2 (0.6*0.7=0.42 < 0.5) gets eliminated! Wait, chunk 3 text only: 0.9*0.3 = 0.27 < 0.5 get eliminated.
    # Actually wait. Let's trace chunk_1: 0.9*0.7 + 0.8*0.3 = 0.63 + 0.24 = 0.87 (kept)
